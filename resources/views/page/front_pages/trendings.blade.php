         ...
         <div class="movie-browse-agile">
            ...
            <div class="browse-agile-w3ls general-w3ls">
               <div class="tittle-head">
                  <h4 class="latest-text ml0">Trendings</h4>
                  <div class="agileits-single-top">
                     <ol class="breadcrumb">
                        <li><a href="{{ url('/') }}">Home</a></li>
                        <li class="active">Trendings</li>
                                       ...
                                       <div class="col-sm-9 wthree-news-info">
                                          ...
                                          <ul style="margin-bottom: 2%;">
                                            <li><i class="fa fa-user" aria-hidden="true"></i>
                                             ...
                                             <li><i class="fa fa-clock-o" aria-hidden="true"></i>{{ date_format(@$trending->created_at,"M d,Y") }}</li>
                                             <li><i class="fa fa-eye" aria-hidden="true"></i> 0</li>
                                          </ul>
                                          <p>{{str_limit(@$trending->description, 300, ' (.......)')}}</p>
                                       </div>
                                    ...
                                    @foreach($trendings as $trending)
                                       <div class="col-md-4 w3-agileits-news-left">
                                          <div class="col-sm-12 wthree-news-img">
                                             <a href="{{ url('/video-details/'.@$trending->id.'/'.str_slug($trending->title)) }}">
                                              @if(!empty($trending->image))
                                              <img src="{{ url('uploads/'.@$trending->image)}}" class="img-responsive img-grid" alt="" />
                                              @else
