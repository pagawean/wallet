...
<head>
    ...
    <meta content="" name="author"/>
     ...
     <!-- BEGIN GLOBAL MANDATORY STYLES -->
        ...
        <link href="{{ url('/metronic/theme') }}/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="{{ url('/metronic/theme') }}/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="{{ url('/metronic/theme') }}/assets/global/css/components.min.css" rel="stylesheet" id="style_components" type="text/css" />
        <link href="{{ url('/metronic/theme') }}/assets/global/css/plugins.min.css" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN PAGE LEVEL STYLES -->
        <link href="{{ url('/metronic/theme') }}/assets/pages/css/login-3.min.css" rel="stylesheet" type="text/css" />
...
<div class="copyright"> 2018 © BALCONY.</div>
<!--[if lt IE 9]>
